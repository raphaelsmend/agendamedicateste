...
<div class="login-box">
    ...
    <div class="login-box-body">
        <p class="login-box-msg">NOVO USUÁRIO - Preencha corretamente os dados abaixo:</p>
        ...
        <form method="POST" action="{{ route('senha.novo') }}">
            {!! csrf_field() !!}
            ...
            <div class="form-group has-feedback">
                <input placeholder="Senha" id="senhanova" type="password" class="form-control @error('senha') is-invalid @enderror" name="senhanova" required autocomplete="Senha">
                <span class="glyphicon glyphicon-lock form-control-feedback"></span>
            ...
            <div class="form-group has-feedback">
                <input placeholder="Confirme a Nova Senha" id="senhanovaconfirma" type="password" class="form-control @error('senha') is-invalid @enderror" name="senhanovaconfirma" required autocomplete="Confirme a Senha">
                <span class="glyphicon glyphicon-lock form-control-feedback"></span>
